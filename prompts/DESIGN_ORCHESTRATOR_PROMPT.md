...
- 주인공은 미래를 위해 오늘을 견딜 이유가 없는 무목표형이며, 친구·게임·밤샘·지각·결석이 한 회피 사슬을 이룸
- 고수준 연표 권위: `canon/CAREER_TIMELINE.md`
- 농구 입문 3단 동기 LOCKED: 만성 지각·결석 뒤 체육관 회피와 조건부 체험→동갑 라이벌 완패로 잔류→첫 리바운드·아웃렛으로 정착
- 입문 동기 권위: `canon/STORY_BIBLE.md`
- 원고 게이트: CLOSED
...
5. 입문 동기를 다시 선택하지 말고 결석·지각·수업 회피의 실제 비용과 담임·생활지도부·감독의 권한을 한국 학교 고증으로 검증한다. 폭력 사고, 양아치 교화, 감독의 징계 삭제를 재도입하지 않는다.
6. 게임은 즉시 보상과 사회적 피난처일 뿐 중독 악역이나 BQ 치트키로 바꾸지 않는다. 출석·성적·NCAA 자격에 남기는 비용만 연표에 연결한다.
7. 2018 Summer League·아시안게임·NBA 캠프·G리그 배정 일정을 한 표에서 충돌 검사한다.
8. 2019 코비 접점은 실제 접근 경로가 확보되지 않으면 `ACCESS_HOLD`를 유지한다.
9. 원고·Act·Sub-Act는 작성하지 않는다.
