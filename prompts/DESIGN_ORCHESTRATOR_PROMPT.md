...
- 농구 입문 3단 동기 LOCKED: 학교 관리형 진입→동갑 라이벌 완패로 잔류→첫 리바운드·아웃렛으로 정착
...
5. 입문 동기를 다시 선택하지 말고 담임·생활지도부·감독의 권한과 징계 유지 조건만 한국 학교 고증으로 검증한다.
6. 2018 Summer League·아시안게임·NBA 캠프·G리그 배정 일정을 한 표에서 충돌 검사한다.
7. 2019 코비 접점은 실제 접근 경로가 확보되지 않으면 `ACCESS_HOLD`를 유지한다.
