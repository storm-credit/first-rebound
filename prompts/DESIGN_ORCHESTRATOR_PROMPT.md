...
`design/ERA_SELECTION.md`의 현대 4안을 다음 기준으로 재검증하라.

- 한국 독자의 NBA 선수 인지도
- 레너드·르브론·커리·요키치·야니스·돈치치 세대와의 접점
- 코비·아이버슨 현역 맞대결을 포기하는 비용
- 주인공 투웨이 SF/PF와의 차별성
- 한국 고교→프렙→NCAA 연표의 현실성
- 시대별 규정·미디어·전술 변화의 서사 가치
- 2026년까지 축적된 실제 역사 길이
- 결말까지 필요한 가상 미래 시뮬레이션 비중
...
- `design/TACTICAL_EVOLUTION_MAP.md`와 `research/TACTICAL_RESEARCH_LEDGER.md`를 읽는다.
- 시대별 전술은 이름을 나열하지 말고 주인공·라이벌의 역할, 출전시간, 계약, 매치업 비용으로 번역한다.
- 주인공: 리바운드/수비/전환/연결 → 스몰볼 5번/숏롤/세컨드사이드 판단.
- 라이벌: 정교한 득점 윙 → 1차 이점 생성 → NBA 플레이오프 카운터와 오프볼 적응.
- Sub-Act당 핵심 전술 문제 1개만 둔다.
- 2020 드래프트 1순위 팀은 원역사 보존이 아니라 2018-20 인과 시뮬레이션 뒤 결정한다.
- 국가대표와 병역은 `design/NATIONAL_TEAM_MILITARY_OPTIONS.md`의 4안을 검증한 뒤 사용자 선택으로 잠근다.
- 이 단계에서도 원고를 쓰지 않는다.
