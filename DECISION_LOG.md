...
| D-185 | AUTHOR_DIRECTION | 두 한국인 선수의 시대 대표 경쟁을 생애 라이벌 축으로 두되 실존 스타의 시즌·시대 경쟁층을 보존 | ‘메시–호날두급’은 목표, 정확 MVP·우승·역대 순위 HOLD |
| D-186 | DESIGN_LEAN | 라이벌은 주인공과 같은 투웨이가 아니라 대형 감속·템포 공격 지휘자 후보 | 하프코트·감속 S+ 후보, 수비 B~B+·연속 폭발·오프볼 약점 유지, 미승인 |
| D-187 | PERSONALITY_LEAN | 라이벌 성격은 강한 에고·공개적 야망·통제된 도발·통제욕 후보 | 상시 허세·괴롭힘 금지, ‘직접 해결’에서 ‘팀 최선 생성’으로 성장, 미승인 |
| D-188 | PHYSICAL_FIREWALL | 아시아인의 생물학적 신체 한계를 서술 사실로 두지 않고 외부 편견과 개인 한계를 분리 | 주인공·라이벌은 서로 다른 희귀 이상치, 국가 증명 서사 금지 |
| D-189 | RELATIONSHIP_LEAN | 국가대표와 중립 민간 퍼포먼스 센터에서 제한적 조언·공동훈련 가능 | PUMA/adidas·팀 코치 권한 보존, 각자 한 문제만 교정, 장소·트레이너 HOLD |
| D-190 | CONFERENCE_CONFLICT | Chicago 라이벌과 Indiana 주인공 잠정 추천은 모두 동부라 전성기 동서부 분리 방향과 양립하지 않음 | 어느 안도 자동 폐기하지 않고 콘퍼런스 구조 선택 전 정본 승격 금지 |
| D-191 | STRUCTURE_LEAN | 라이벌 Chicago 유지+주인공 2023 서부 이적을 동서부 분리 구조 추천으로 등록 | Indiana 후보 재개방, Sacramento 포함 서부 4안 재검증 전 팀 NOT_CANON |
| D-192 | LOCKED | 주인공 최종형은 플레이오프 공격 1옵션이 가능한 S급 투웨이 슈퍼스타 | 수비형 연결자로 종결 금지, 정확 기록·수상·우승은 R09 이후 HOLD |
| D-193 | LOCKED | NBA 장기 성장의 본체는 매년 이전 약점을 하나씩 지우는 연차별 업그레이드 | 시스템 없음, 약점 노출→비용→교정→사용→재대응→자동화 필요 |
| D-194 | LOCKED | 정점에서 리그 최고 선수 논쟁과 시대 지배가 가능 | 매년 MVP·DPOY·득점왕 독식 금지, 실존 스타 경쟁층 보존 |
| D-195 | LOCKED | 공격 부하가 커지면 수비 S 출력은 플레이오프·클러치에 선택적으로 집중 | 82경기 내내 공격·수비 최대출력 금지 |
| D-196 | SUPERSEDES_DIRECTION | D-165·D-167·D-184의 `Atlanta 연결자→2023 이적→두 번째 팀 S급` 전제를 현행 기본값에서 해제 | 실제 코치·분·거래 증거는 보존하고 Atlanta 원클럽/가치 이적을 재계산 |
...
| D-472 | BPM_SNAPSHOT_MAR25_SCOPE | 공개 보관본505명의 GP·누적 분을3/25 NBA 관측과 대조; 최초3/24 추정 정정 | 원사이트403·BPM 재계산 미수행·마감일 전 정보 아님 |
| D-473 | ZERO_CLOCK_APPEARANCE_AUDIT | Tacko2/23의0:00 행을 GP에 포함해10경기 재현 | 양의 분이나 추가 가용성 근거로 바꾸지 않음 |
| D-474 | TWO_FAMILY_CROSSCHECK | RAPTOR·BPM 두 계열, 후반2106/전반1161 모형·피로 조건 검산 | 원BPM/수축BPM을 독립 두 계열로 세거나 통계적 독립 주장 금지 |
| D-475 | CONDITIONAL_POST_RECORD_STABILITY | 두 수축 지표는 전 조건 후반12승 방향, 원BPM은 라이벌 극하방에서만12~13승 | 거래·가용성·라이벌 능력·exact 승수 미선택 |
| D-476 | PORTER_SCOPE_ALIGNED | 전반 Porter RAPTOR를CHI 한 팀에서 전 팀으로 정렬, 수축 rating+0.120632 | 전반 승수 방향 변화 없음, 과거 원장은 이력 보존 |
| D-477 | PREDEADLINE_OPPONENT_18_SCREEN | 양 팀1144행·43경기 중10팀18경기의 변화와 실제 제거 접촉231:39 특정 |0분 접촉도 새 선수0분 증거 아님; 나머지25경기도 제한적 후보 |
| D-478 | O15F9_SCOPE_CLOSED | 두 계열·표본 날짜·범위·피로 비교 종료 | 새 입력 없으면 후반 감사 반복 금지 |
| D-479 | O15F10_NEXT | 전반 상대18경기 조건부 입력과72경기 연결, Portland/GSW 접전 우선 | 단순 시즌 합산·순위·픽·여름 계약 선잠금 금지 |

| D-480 | O15F10_SEASON_CONNECTION | 전반43경기와 후반29경기를 같은 영향 형식으로 연결하는 기준선 진단을 저장 | 산술 승수는 정본 기록·선택 경로가 아니며 기존19~21승과 평균내지 않음 |
| D-481 | PREDEADLINE_REPLACEMENT_VECTORS | 10팀18경기에 실제 대체 접촉을 1:1 초 벡터로 보존 | Trent→Evans 등 미정 계수는 상징값으로 유지; 0분을 가용성으로 발명하지 않음 |
| D-482 | OVERTIME_SECONDS_PRESERVED | Minnesota·Denver 연장 경기의 실제 팀 총초를 14,400초로 절삭하지 않음 | 실제 총초 보존은 선수 대체·승패 확정과 별개 |
| D-483 | SEASON_PATH_UNSELECTED | 전반18경기와 후반39조건은 모두 `selected=false`로 유지 | 날짜별 유리한 거래·가용성 가지 혼합 금지 |
...
| D-508 | DRAFT_2021_RELEASE_RECOVERED | 해당연도공식동률/lottery발표확보;D-505의원문미확보범위를갱신 | 새조합·14팀·추첨·정확픽미선택 |
| D-509 | NON_CHI_1008_CONTACT_SCREEN | 직접526/거래조건103/직접변경미특정379,중복없이1008경기 | 미특정=무영향금지;날짜경계=즉시등록금지 |
| D-510 | ONE_RESULT_SENSITIVITY_3024 | CHI31/32/33각1008단일결과변경,반대팀이전·1080승보존 | 예측·확률·사건선택아님 |
| D-511 | PLAYIN_NOT_33_WIN_TARGET | CHI32승+CHA1패또는CHI31승+CHA2패경계반례,33승도탈락가능 | 피로0/지표선택을플레이인목표로역산금지 |
| D-512 | BOUNDARY_QUEUE_29 | 순위민감131경기중3점이하29우선,102후속/877나머지 | 3점은영향상한아님;서부/lottery/다중변경검토면제금지 |
| D-513 | EXECUTION_CONDITIONS_EX01_08 | 거래/등록/건강/픽선행조건및Chicago기본급여여유정리 | 보너스0/실제타팀부상복사/타거래승인확장금지 |
| D-514 | O15F14B_NEXT | Charlotte근소승패부터양팀실제입력·영향연결,이후WAS/IND·서부 | O15F14전체·Chicago시즌완료아님;기존분감사반복불요 |

| D-515 | O15F14B_PAIRED_29_OBSERVED | 우선29경기 양팀776행·원본1080경기점수대조·7연장 보존 | 공개보관본 수치이며NBA직접추출/대체세계 연장승인 아님 |
| D-516 | CONDITIONAL_ROLE_90 | 변경32팀날짜 LOW/HIGH64안·실제유지26안;64개5인조합 | 새선수 건강/등록·Brown잔류분·Wanamaker합류는 조건;부상공짜분금지 |
| D-517 | CENTER_ROLE_NOT_CLOCK_ERROR | WAS6날짜/TOR1날짜 센터추가초를 다른선수분으로충당 | ±1초 관측잔차와구분;실제교체/의학상한승인아님 |
| D-518 | PAIRED_348_DIRECTION | 24유지/2역전/3불일치;양팀분영향·추가업무량 반대부호 | 유지4경기는양팀실제유지가정;평균/유리한날짜혼합금지 |
| D-519 | LIMITED_BRIDGE_72 | CHI72+우선29만변경,979실제유지;RAPTOR32~33승9위/BPM31승10위 | 1080승·이전합0보존;플레이인보장/최종시즌정본아님 |
| D-520 | O15F14C_NEXT_KOREAN_REPORT | 남은리그/서부/lottery·EX01~08·시즌선택연결;한국어7행진행표 | 현재2020–21우선,장기커리어까지전체목표;같은29분감사반복금지 |

| D-521 | FULL_SEASON_IDENTITY_FIVE | 72조건을승수뿐아니라전체결과변경ID가같은5경로로묶음 | 횟수를확률/증거무게로사용금지 |
| D-522 | CONFERENCE_TIES_CONNECTED | 양컨퍼런스순위,2팀/다중동률·부분동률재시작검산 | 이후기준필요시중단,실제점수차복사금지 |
| D-523 | CHI_FIRST_OPPONENT_CORRECTION | 조건부9위홈WAS/CHA또는10위WAS원정 | 첫상대항상WAS라는중간보고정정;선행CHI9/10위자체는유효 |
| D-524 | PLAYIN_320_ENUMERATED | 경로당양컨퍼런스64분기·25개서로다른lottery명단 | 경우의수는확률아님;경기/추첨미선택 |
| D-525 | CONDITIONAL_PICK_RECORD_ORDER | 탈락시31승8~10/32승9~12/33승11~13성적슬롯;PO시15~16 | 979실제유지가정;정확픽아님;CHI자체픽보유 |
| D-526 | REMAINING_BOUNDARY_280 | 5×979단일변경4895건의경계합집합280,40접전양팀1082행확보 | 모든979신규영향미계산;나머지면제금지 |
| D-527 | O15F14C_CONTINUE_EXECUTION | 다음40양팀영향·Gordon급여/픽/수용조건구체화 | EX01~08미해소,기존완료도구반복금지,시즌HOLD |

결정 변경 시 기존 행을 삭제하지 않는다. 새 ID로 변경안을 기록하고 폐기된 결정은 `SUPERSEDED`로 표시한다.


## 2026-09-11 O-15F14-D — 추가40경기 영향

- 사용자 인수인계는 B 완료였으나 실제 main에 C/PR147이 있어 완료된 C를 재작업하지 않고 후속으로 진행했다. 단계 이름은 O-15F14-D로 구분한다.
- 결과 권위: `simulation/CHICAGO_2020_21_REMAINING_PAIRED_IMPACT.md` 및 JSON. 날짜별 유리한 지표 선택 없이 기존 시즌 조건에 연결했다.
- 판단: 추가40의 조건부 영향 완료, 전체 시즌 미완료. Gordon은 Clark 명목 급여·실행 필드·대안별 재계산 범위만 추가 확보, 정확 거래 HOLD.
- 새 결함 교정: Enes 이름을 선수ID로 연결; POR4/20 선발 센터 역할 중첩129초를 명시적 분 이전으로 지불. 가용성 승인·NBA 규정으로 과장하지 않음.
- 검증: 신규6 + 선행11 회귀, JSON/CSV 재현. 자체검토 NOT_INDEPENDENT; 원격CI PASS 주장 없음. 다음 O-15F14-E, 원고CLOSED.


## 2026-09-11 O-15F14-E — 시즌 정책·전체 잔여 접전80

- PR148 main에서 후속 실행. 939경기/1878노출/25042관측행 정책색인과 D7경로6573가상반전 검사 완료; 신규 영향은 그중80경기다.
- 양팀2169행·228분안·100변경조합·1176영향조건,71유지(49실제유지가정)/9미정. 기존 B/C/D 결과 불변.
- MIN센터 역할 최초안이 Reid/Davis 추가15~20분을 만들어 폐기했다. 네 대안 비교 후 Vanderbilt 스몰볼을 조건부 분석안으로 명시해 재계산; 실제 교체/전술/건강 승인 아님. 최종65경로이며 중간66값은 폐기.
- 같은 라이벌 실력을 선행72조건과 공유해564구간 연결. 다른859실제유지, Chicago9/10위·MIN21~29승은 조건부 진단. 경로별64플레이인조합/25명단,확률·사건·정확픽 미선택.
- EX01~07 팀/날짜 의존과 EX08 경로 의존 연결. 정확 charge/픽/새 건강 근거를 확보했다고 주장하지 않음.
- 검증17개·JSON/CSV재현 통과; 자체검토NOT_INDEPENDENT. 다음F는859영향범위·실행조건·시즌선택보드, 원고CLOSED·큰작업6개남음 유지.


## 2026-09-11 O-15F14-F — 잔여859 전량·전체1080 연결

- PR149 main에서 이어감. 기존221계산은보존하고859경기22873관측행을확보해정규시즌입력큐를마감했다.
- 공통최소분변경LP로1252변경안·11748영향조건. 점수/지표로분배역산금지,신규목표/기존상한/부상DNP보존.
- 기본역할7경기14안실패는보존. 상한완화/부상복귀없이Hood·Ross진행,Griffin·Nnaji골밑비상역할을조건부로추가했다. 실제전술/건강확정아님.
- 336역할비용스트레스에서6점/48분·BOS–DET2/12 HIGH/BPM/피로1의반전반례를보존;기본149경로강건성으로오인금지.
- 849유지(422양팀실제배정가정)/10MIN변수,같은라이벌실력으로선행564→1198구간·149전체경로. 미계산0·CHI9/10조건부. MIN39끝점은경험리그범위이지권장성장선아님.
- 새플레이인첫대진에IND홈–CHI추가.64조합/25명단·픽성적슬롯은확률/사건선택아님.4정책군·EX01~08보드작성,정확거래/건강사실미해소.
- 검증신규9+E6=15·재현통과,자체검토NOT_INDEPENDENT. 다음G는최종전제/사건작가검토패킷,새경기배치반복금지. 전체남은6·원고CLOSED.
...
## 2026-09-12 O-15G5 — 2021 픽 원소유·조건부 거래 연결
...
## O-15G10 — 실제 독서에서 문체 기능만 반영

- 세 작품16회차의 공개 본문을 직접 읽고 접근·관찰·원문 없는 계량 입력을 기록했다. 기본110화 대비94화 미독서, 전체 문체 검토 완료 아님.13후보도 최종10작품 선정이 아니다.
- 성공의 반응/기술 평가/역할 권한을 구별하고 위치→행동→반응을 연결하는 기준을 보강했다. S1 제한3인칭 추천과 조용한 주인공을 유지한다. 작품의 말투·회귀/시스템·미래 정보·폭력 보상을 채택하지 않는다.
- p620개22,876자의 산술은 재현 가능하지만 문장 길이·대사 비율·초반1000자 계량은 미측정이다. 숫자로 연구 완료를 대신하지 않는다.
- 설계 샘플2개의 문체 출처 범위를 독서/비교3파일까지 넓히고, 의도한 문체/Freeze 변경을 검토한 뒤 해시를 갱신한다. 원고0·정본 승격0·자체 검토 NOT_INDEPENDENT.
