...
- 최근 설계 변경: `basketball-to-responsibility five-stage character arc`
...
- [x] 게임·허세·말 많은 성격 유지와 BQ/책임 성장 분리
...
2. 성숙 뒤 주인공을 조용한 모범생으로 바꾸면 고유 성격이 사라진다. 허세·농담·게임은 유지하고 신뢰성만 변화시킨다.
