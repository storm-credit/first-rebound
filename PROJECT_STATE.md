...
- [ ] 프렙 학교 유형 4안과 전학·졸업·노출 경로
- [ ] 한국·프렙 과목의 범주별 NCAA core-course 충족표
- [ ] Villanova 리크루팅·입학·장학금 한 경로
...
12. 대학의 흥미로운 실존 자료를 계속 추가하면 NBA 장기 성장물이 대학물로 이동한다. 세 항목 종료 패킷 뒤 대학 범위를 닫는다.

## 다음 게이트

대학 구간은 B 최소 완결안으로 제한했다. 프렙 유형·자격 범주표·리크루팅/장학금 한 경로의 세 항목만 완료한 뒤 `COLLEGE_ARC_SCOPE_COMPLETE`로 닫는다. 정확한 40경기·Texas Tech 개인 수치는 R09로 미루고, 즉시 라이벌 부상 경로와 2018 Draft·첫 NBA 팀·국가대표 병역 일정으로 이동한다.
