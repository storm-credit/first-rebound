...
- 기준 브랜치: `main`
- 현재 작업: `O-15F14 리그 경계 파급·시즌 선택 선행 조건 회수`
- 최근 설계 변경: `O-15F13 BASE72조건·31/32/33승 결산; 1080경기 기준선·상대 승수 이전·동부11/11/10위 조건부 진단·서부 경계·픽 소유권/성적순서 분리`
- 선행 감사 병합: `PR #143 / cd56f051553925e13dee826a8f02db6a27585abf`
...
다음 **O-15F14는 리그 경계 파급·시즌 선택 선행 조건 회수**다. O-15F13의 31/32/33승 후보 결산·조건부 동부11/11/10위·픽 보드는 완료했다. 다른1008경기는 실제 유지 진단이며 최종 리그 순위가 아니다. 33승은 RAPTOR 피로0에서만 나오고 두 접전 지표 불일치를 유지한다. 거래/등록/가용성, Chicago 외 경기 파급, 시즌 경로 선택, 플레이인/해당연도 동률규칙/lottery 순으로 남은 조건을 회수한다. 2021 정확 조합 원문 미확보로 odds·추첨은 HOLD. 동일 분 검산은 새 입력 있을 때만 수행한다. 전체 진행표는 매번 종료 답변에 같은7행으로 표시하며 큰 작업1완료·1진행·5대기, 진행 중 포함6개 남음. v0.30 PARTIAL·설계/원고 CLOSED 유지.
