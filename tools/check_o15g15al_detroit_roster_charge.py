...
assert room - olynyk + minimum == ledger["alternate_nominal_room_after_olynyk_first"]
...
for name, key in (
    ...
    ("Saben Lee", "alternate_olynyk_margin_if_lee_first"),
    ("Isaiah Livers", "alternate_olynyk_margin_if_livers_first"),
):
    assert room + minimum - additions[name] - olynyk == ledger[key]
