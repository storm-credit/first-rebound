...
const expected = [
  ...
  ['16', 'Detroit Pistons', 'Kira Lewis Jr.', 'AUTHOR_LOCKED'],
];
...
for (const marker of [
  'AUTHOR_APPROVED / PICKS_14_TO_16_LOCKED / STEWART_RELANDING_OPEN',
  'Aaron Nesmith 14순위 `AUTHOR_APPROVED / LOCKED`',
  'Cole Anthony 15순위 유지 `AUTHOR_APPROVED / LOCKED`',
  'Kira Lewis Jr. 16순위 `AUTHOR_APPROVED / LOCKED`',
...
if (!review.includes('AUTHOR_RESOLVED_TO_16')) throw new Error('missing author resolution');
if (!review.includes('STEWART_RELANDING_REQUIRED')) throw new Error('missing Stewart relanding requirement');
...
console.log('Nesmith 14 / Cole 15 / Kira 16 author-locked; Stewart relanding required');
