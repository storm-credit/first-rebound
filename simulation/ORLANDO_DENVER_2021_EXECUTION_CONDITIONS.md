...
`NBA_2021_ASSET_CHAIN.md` 및동명JSON에서Bane거래의MEM2025출처, BostonTPE사용보도/후대11.05m목록, Denver선행미전달2025·26 2R전환보도를회수했다. 이문서의선행종료미확보는해당보고범위에서이력이다. 정확원계약·Gordon후행연결/종료·당일charge·작가채택은여전히HOLD이며기존분/시즌수치를바꾸지않는다.
