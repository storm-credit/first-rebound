...
| F4 / 등록 | [등록 장부](ORLANDO_2020_21_REGISTRATION_LEDGER.md), [5경기 공개 `Out` 상태](../research/O15F14N_HALL_MAY9_16_FOUR_PLAYER_STATUS.md), [후반 9계약 비용](NBA_2020_21_REGISTRATION_COSTS.md), [ORL 급여](ORLANDO_2020_21_PAYROLL_BOUND.md), [BOS/DEN 급여](BOSTON_DENVER_2020_21_PAYROLL.md): 비용·기간·팀 한도 시험 및 원역사 보고 상태 연결. ORL 조건부 apron 여유 $14,720,745 | 팀별 미포함 순증 부담과 정확 사용 예외·한도. Hall 5/9~16의 추가 등록 허가 사건은 A2 미채택; 경기 전 `Out` 20행은 승인 문서가 아님. 보고 cap-hit 0의 당시 적용 근거는 HOLD이나 전액 비용안으로 검사할 수 있어 0을 반드시 채택할 필요는 없음 |
