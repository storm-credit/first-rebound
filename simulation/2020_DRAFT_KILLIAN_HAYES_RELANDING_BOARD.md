...
Patrick Williams가 Detroit 7순위로 이동했으므로 Hayes를 삭제하거나 임의 팀에 배치하지 않는다. 8순위 New York부터 실제 지명자의 구단 선호와 Hayes의 당시 평가를 한 팀씩 비교한다. 후대 NBA 성과와 계약은 사용하지 않는다.

## 2. New York 8순위 — Obi Toppin 유지 주안

- New York은 당시 포인트가드가 필요했고 Hayes를 인터뷰했으며, 12개 매체 consensus에서 Hayes가 8순위 최빈 예상이었다.
...
- Avdija는 당시 top-five권 평가에서 9번까지 미끄러졌고 Washington은 그 가치를 반겼다.
...
- Phoenix는 드래프트 직전 Chris Paul을 영입해 즉시 주전 포인트가드를 확보했다.
...
- Brian Wright는 원칙적으로 BPA를 택하고 동급일 때만 포지션을 본다고 밝혔다.
...
- Haliburton은 더 높은 순번 예상에서 12번까지 내려온 가치 선택이었다.
...
- New Orleans는 실제로 Kira Lewis Jr.를 지명했으므로 기존 가드 숫자에도 불구하고 젊은 포인트가드를 추가할 의사가 있었다.
- Pelicans 공식 사이트의 동시대 mock 정리에는 Hayes 13순위안이 포함됐다.
...
- [SNY — Knicks의 Hayes 사전 인터뷰](https://sny.tv/articles/knicks-among-teams-to-interview-french-guard-killian-hayes)
- [SNY — Toppin 지명과 구단의 coveted 평가](https://sny.tv/articles/knicks-select-obi-toppin-with-no-8-pick-in-2020-nba-draft)
- [Daily Knicks — Toppin이 8순위에 남을 경우의 동시대 구단 선호 보도](https://dailyknicks.com/2020/10/22/knicks-draft-obi-toppin-seeking-advice-kevin-knox/)
- [Washington Wizards — Avdija 지명 평가](https://www.nba.com/wizards/wizards-continue-build-historic-pick-avdija)
- [Arizona Sports — James Jones의 Jalen Smith best-fit 설명](https://arizonasports.com/empire-of-the-suns/suns-gm-james-jones-jalen-smith-was-best-fit-for-phoenix-in-nba-draft)
- [KSAT/AP — Brian Wright의 BPA 원칙과 Vassell 선택](https://www.ksat.com/sports/2020/11/19/spurs-go-3-and-d-select-florida-state-wing-devin-vassell-in-nba-draft/)
- [Sacramento Kings — Haliburton 12순위 지명](https://www.nba.com/kings/news/kings-select-tyrese-haliburton-first-round-2020-nba-draft)
- [New Orleans Pelicans — 동시대 mock의 Hayes 13순위안](https://www.nba.com/pelicans/news/mock-drafts-project-pelicans-add-two-way-wing-wednesday)
