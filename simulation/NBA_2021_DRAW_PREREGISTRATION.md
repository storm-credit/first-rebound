...
위 상태와 본문은 실행 전 기록으로 보존한다. 게시 커밋 `2f77a4eac597dc7eaab0127ec4d83123e42b5c85` 이후 첫 실행 결과는 [잠정 결산](NBA_2021_PROVISIONAL_DRAFT.md)에 있다. 입력 JSON/알고리즘은 결과 확인 후 변경하지 않았다.
