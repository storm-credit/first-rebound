...
> 후속 O-12E 연쇄 감사에서 Griffin 16순위와 Bey 4팀 거래를 저훼손 기준선으로 보존하면서 2022-23 후보는 64~72경기·24~26분·1,550~1,800분으로 하향됐다. 최신 후보 권위는 `simulation/ATLANTA_2019_22_CAP_DRAFT_TRADE_CASCADE.md`이며, 두 범위 모두 정본 기록이 아니다.
