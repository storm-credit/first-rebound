...
Denver가 Saddiq Bey를 22순위로 선택했으므로 Nnaji를 삭제하거나 23순위 이하를 기계적으로 한 칸씩 밀지 않는다. Minnesota가 통제한 23순위와 Denver가 별도 거래로 얻은 24순위를 순서대로 비교한다. 선수 선택과 픽 거래의 경제는 분리하며 후대 NBA 성과·부상·계약은 사용하지 않는다.

## 2. Minnesota 통제 23순위 — Leandro Bolmaro 유지 강한 주안

- Minnesota는 드래프트 밤 New York에 25·33순위를 보내 23순위로 올라가 Bolmaro의 권리를 얻었다. 이는 단순 실제 지명보다 강한 목적 상향 거래다.
- 공식 완료 거래는 Minnesota가 Ricky Rubio·Bolmaro 23·Jaden McDaniels 28을 받고, New York이 Immanuel Quickley 25와 추가 권리를 받는 더 큰 3팀 구조였다. 따라서 `25+33 단독 교환` 보도와 최종 거래 원장을 같은 사건의 서로 다른 단계로 구분한다.
...
- 실제 Denver는 자신이 보유한 22순위로 Nnaji를 먼저 지명했고, R.J. Hampton의 24순위 권리는 별도 4팀 거래로 획득했다.
- 이 순서는 Nnaji가 최소한 첫 보유 픽에서 보호된 선수였고 Hampton은 추가 픽 거래가 성립한 뒤 확보한 선수였다는 강한 관측치다.
...
- [NBA — New York–Minnesota 23·25·33순위 드래프트 밤 거래 보도](https://www.nba.com/news/reports-knicks-trade-23rd-overall-pick-to-timberwolves)
...
- [Denver Nuggets — Nnaji 22 지명·Hampton 24 거래](https://www.nba.com/nuggets/news/nuggets-pick-zeke-rj-202011)
- [Denver Nuggets — Nnaji 22순위 지명 발표](https://www.nba.com/nuggets/news/nuggets-draft-20201118)
