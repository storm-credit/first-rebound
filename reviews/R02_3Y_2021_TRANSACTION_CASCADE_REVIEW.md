# R02-3Y 2021 Transaction Cascade Independent Review
...
두 판정 모두 **2021 사건의 구조적 가능성**만 보여준다. 대체 Chicago와 Portland가 실제 그 선택을 하는지는 앞선 시즌을 시간순으로 계산하기 전 확정할 수 없다.
...
| 법적 거래 구조 PASS를 실제 발생 LOCK으로 확대 | Chicago 2020-21 성적·Vučević 거래·보강 동기를 O-15D 선행조건으로 등록 |
| 미래 역사를 덜 바꾸는 안을 선택 근거로 사용 | 당시 팀 동기·급여·자산가치로 선택하고 변경량은 비용으로 기록 |

## 반대 가능성

1. Washington의 Trent가 실제 Portland Trent에 가까운 슈터로 성장하면 별도 마감일 거래나 높은 QO·RFA 계약이 생길 수 있다.
2. Portland의 Evans가 2021년까지 20분대 3&D로 성장하면 Hood+Evans가 Toronto 협상선에 들어올 수 있다.
3. Portland가 Powell 영입을 강행하면 Hood+Little+미래 2라운드가 가장 현실적인 대안이나 Little의 이후 경로 전체가 열린다.
4. Chicago의 대체 성적이나 Vučević 거래가 달라지면 Theis·Green을 얻을 이유 자체가 사라질 수 있다.

## 맹점 검토 최종 판정

- `2021_CHI_WAS_BOS_CAP_STRUCTURE_PASS`
- `TRENT_WASHINGTON_KEEP_PRIMARY / RFA_PATH_PASS / CONTRACT_HOLD`
