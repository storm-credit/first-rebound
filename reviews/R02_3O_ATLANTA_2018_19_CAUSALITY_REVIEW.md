...
- 판정: `BASELINE_PASS / COUNTERFACTUAL_HOLD`
...
| 게이트 | 판정 | 근거 |
|---|---|---|
| G0 Spellman 새 팀 파급 | HOLD | 2018 Draft 30~60 보드 미실행 |
...
1. 2018 Draft 30~60 팀별 후보 보드에서 Spellman의 새 팀을 확정한다.
2. Atlanta 경기별 availability와 Spellman 실제 player-game 분을 수집한다.
3. 주인공의 자기관리 실패·Erie 배정 구간을 결과 보기 전에 잠근다.
4. 82경기 donor vector와 low/base/high 영향 prior를 만든다.
