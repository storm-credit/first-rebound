...
1. Cleveland의 실제 Okoro 지명은 Patrick이 없던 보드에서 나온 결과다. 다만 Altman의 최고재능·fit 발언이 있어 유지 근거가 강하다.
2. Atlanta의 실제 Okongwu 선택도 Patrick과 직접 비교한 공개 보드가 아니다. Hunter·Reddish 중복은 Okongwu 유지 근거지만 mock 두 곳의 Patrick 6번을 지우지 않는다.
3. Detroit promise는 scout·executive의 믿음을 전한 소문이지 구단 확인이 아니다. `PRIMARY_LEAN`을 `LOCK`으로 과장하지 않는다.
