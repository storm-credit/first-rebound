...
| D2 | 2021 선수 보드·실제 계약 | 바뀐 top4부터 보드/소유권, CHI10·39와 백업C 취득·예외 순서, [G8B Markkanen 선수 동의](../research/O15G8B_MARKKANEN_2021_CONSENT_GATE.md) | [G7 60픽 비교](../simulation/NBA_2021_FULL_DRAFT_COMPARISON.md)·[G8 순서/공식 발표 대조](../simulation/CHICAGO_2021_23_CONTRACT_SEQUENCE.md)·[G8C 잔류/이탈 비용](../simulation/CHICAGO_2021_MARKKANEN_OFFER_STRESS.md) 사용. CHI10 Duarte·39 Wieskamp·Bradley·Caruso SQ1은 조건부 주 경로이며 최종 지명·대체 계약/동의·당일 거래는 미완료 |
...
| 묶음 | 현재 구체적인 주 추천 | 이 선택으로 자동 확정되지 않는 것 |
|---|---|---|
| 시즌/가용성 | A1/A2/A3·K1/L2, 사전 기록된 M 추첨 유지 | 실제 의료/등록 승인·charge·선행 픽 조항 |
| 2021 자산/지명 | AP1·DB1·C39A: CHI10 Duarte/39 Wieskamp | 실제 계약·당일 추가 거래·전체 대체 대학 참가자/구단 의료 감사 |
| 2021 취득 | G1A·SQ1: Mark/Green 유지·Caruso NTMLE·백업 최소계약 | 상대/선수의 동의·미기재 비용·실제 연간 출전 |
| 2022 계약 | P E2·Carter CX1·RT1 유지 조건 | P 정확 순번/자격·2022 새 지명·FA/옵션 의사 |
| 장기 코어 | LM1·BC1, LaVine 기존2026 옵션 비용 보존 | 연장 합의·Higher Max 자격·옵션 선택·미배정 예산의 실제 charge |
| 장기 사건 | H2·RC1·AW2, 2028 CHI–MIN 결말 기능·2035 은퇴 추천 | 각 시즌 전력/가용성·우승/수상·2030 이후 새 CBA |
| 구조/문체 | 14 Act/42 Sub-Act·5약속·S1 기초 | 실제780회차 기능표·원고·전체 딥리드·독립 검수 |

각 묶음의 네 대안은 상세 권위에 보존되어 있다. CP2는 이 추천으로 후속 계산을 하는 절차 승인이고, 위 선택 전체를 작가 확정했다는 기록은 아니다. G17은 설계100%와 집필 전환의 명시 승인 단계이므로 현재의 연구/추천 PR 병합으로 통과시키지 않는다. 이미 승인된 Chicago 원클럽·Minnesota2020#1·LaMelo4·Theis/Green A·R1/T1~T4는 다시 묻지 않는다.
